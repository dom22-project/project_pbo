...
CREATE TABLE IF NOT EXISTS database (
    ...
    CONSTRAINT fk_parent_id FOREIGN KEY (parent_id) REFERENCES database(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS paket_tindakan (
    ...
    CONSTRAINT fk_pbo_id FOREIGN KEY (pbo_id) REFERENCES database(id) ON DELETE CASCADE,
    CONSTRAINT fk_tindakan_id FOREIGN KEY (tindakan_id) REFERENCES tindakan_items(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ============================================
-- Insert Default Room Types (Optional)
-- ============================================
INSERT IGNORE INTO room_types (nama_kamar, harga_per_hari, deskripsi) VALUES
    ('Basic', 350000, 'Ruang rawat dengan fasilitas dasar'),
    ('Standard', 750000, 'Ruang rawat standar dengan fasilitas lengkap'),
    ('Deluxe', 950000, 'Ruang rawat dengan fasilitas premium'),
    ('VIP', 1900000, 'Ruang rawat VIP dengan fasilitas mewah'),
    ('VVIP', 2000000, 'Ruang rawat VVIP dengan fasilitas eksklusif'),
    ('Suite', 5000000, 'Ruang suite dengan private facilities'),
    ('Presidential Suite', 7500000, 'Presidential suite dengan fasilitas tertinggi');

-- ============================================
-- Insert Default Operations (Optional)
-- ============================================
INSERT IGNORE INTO operation_tables (kode, nama_tindakan, kelas, biaya_dokter, biaya_rs, total_biaya) VALUES
...
-- ============================================
ALTER TABLE database ADD INDEX idx_version_number (version_number);
ALTER TABLE paket_tindakan ADD INDEX idx_kategory (kategory);

-- ============================================
-- Display Success Message
-- ============================================
SELECT 'Database PBO telah berhasil dibuat!' AS Status;
